...
interface MovieService {
    ...
    fun getMoviesByGenre(@Query("page") page: Int,
                         @Query("with_genres") with_genres: Int): Single<RemoteMovieResponse>

    @GET("movie/{movie_id}")
    fun getMovieById(@Path("movie_id") id: Int): Single<RemoteMovieResponse>

    @GET("movie/{movie_id}/reviews")
    fun getReviewByMovieId(@Path("movie_id") id: Int,
                           @Query("page") page: Int): Single<RemoteReviewsResponse>
