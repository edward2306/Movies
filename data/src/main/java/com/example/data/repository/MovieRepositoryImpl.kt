...
class MovieRepositoryImpl(private val moviesMapper: MovieMapper)
    ...
    override fun getMoviesByGenre(id: Int, page: Int): Single<MovieResponse> {
        return ApiClient.movieService().getMoviesByGenre(id, page).map {
